...
const AddHomeworkScreen=({navigation}) => {
    ...
    const homeworkContext = useContext(HomeworkContext);
    const {addNewHomework, refreshHomework} = homeworkContext;

    const insertarTarea = async () =>{
        if(name){

            await addNewHomework(name, clas, details, date, refreshHomework);
            navigation.goBack();
        }else {
          setError(true);
        }
            ...
            <Content>
                <Card style={styles.card}>
                    ...
                    <CardItem style={styles.cardinput}>
                        <Input  placeholder="Nombre de la tarea" value={name} onChangeText={setName} />
                    </CardItem>
                    <CardItem style={styles.cardtext}>
                    ...
                    <CardItem style={styles.cardItem}>
                        <Button rounded style={styles.MostrarButton} onPress={insertarTarea}>
